  ...
  return (
    ...
    >
      ...
      <div className="mx-3 my-[0.4rem] flex w-2/3 flex-row-reverse flex-wrap items-center  gap-4 ">
        <Avatar />
        <OpenModal
          className=" bg-gradient-info center text-white hidden  lg:flex  h-full  gap-1 rounded-xl border-gray-600 px-5 shadow-md hover:border-none hover:text-white  dark:border-2 dark:bg-transparent dark:text-gray-300 "
          name={title}
        >
